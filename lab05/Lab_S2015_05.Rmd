...
## Compare against manually center.
```{r}
lab5$ecabmc <- lab5$ecab - mean(lab5$ecab, na.rm = TRUE)
attributes(lab5$ecabmc2)
lab5$ecabmc2 <- scale(lab5$ecab, center = 20,  scale = FALSE)
plot(ecabmc ~ ecab, lab5)
```
