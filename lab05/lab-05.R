...
## ECAB: Economic ability index, in which income, retail sales, 
##		##and the value of output (manufactures, mineral, and agricultural) 
##      ##per capita are equally weighted.	
...
lab5 <- read.table("Lab-2014/lab5/publicspending.txt", header = TRUE)
