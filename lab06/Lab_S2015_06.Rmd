...
```
- factor variables are in the core emphasis of the movement behind the
  S and R languages. It has been adopted by SAS and Stata as well.
...
$$
ex_i = \beta_0 + \beta_1 ecab_i + \beta_2 met_i + \beta_3 grow +
$$
$$
\beta_4 young_i + \beta_5 old_i + \beta_6 regionWest + e_i
$$
